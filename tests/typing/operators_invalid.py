...
codifferential(geometry, star)


def consume_degree_two_laplacian(
    value: LinearMap[
        CochainSpace[Domain, Literal[2]],
        CochainSpace[Domain, Literal[2]],
    ],
...
consume_degree_two_laplacian(hodge_laplacian(geometry, space_3))
