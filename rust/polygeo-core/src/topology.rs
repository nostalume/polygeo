//! Admitted topology, capabilities, incidence, subsets, and halfedge surfaces.

pub use crate::complex::{CandidateInput, ComplexCore as Complex};
...
pub use crate::halfedge::{
    Edge, ExteriorHalfedge, FaceKind, FaceOrbit, Halfedge, HalfedgeInput,
    HalfedgeSurfaceCore as HalfedgeSurface, MaterialBoundaryHalfedge, MaterialFace,
    OrbitMaterialization, OrbitMaterializationParts, Vertex,
};
pub use crate::incidence::{
    Basis, BoundaryRef, CanonicalBoundary, ChainView, CoefficientSlice, ExactEntries,
};
pub use crate::subset::{CanonicalSelection as Selection, SimplexSubset as Subset, SubsetBuilder};
